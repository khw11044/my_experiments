...
# 각 view별 3d pose 
v0_3dp = (pred_rot[0] @ (view0_cano_3d_joints - np.array([0,0,1])).T).T
v1_3dp = (pred_rot[1] @ (view1_cano_3d_joints - np.array([0,0,1])).T).T
v2_3dp = (pred_rot[2] @ (view2_cano_3d_joints - np.array([0,0,1])).T).T
v3_3dp = (pred_rot[3] @ (view3_cano_3d_joints - np.array([0,0,1])).T).T
...
# =====================================================================================
ax3 = fig.add_subplot(2,2,2, projection='3d', aspect='auto')
show3Dpose(view0_cano_3d_joints, ax3, data_type='h36m', radius=2, lcolor='black',angles=(20,-60))
show3Dpose(view1_cano_3d_joints, ax3, data_type='h36m', radius=2, lcolor='blue',angles=(20,-60))
show3Dpose(view2_cano_3d_joints, ax3, data_type='h36m', radius=2, lcolor='red',angles=(20,-60))
show3Dpose(view3_cano_3d_joints, ax3, data_type='h36m', radius=2, lcolor='green',angles=(20,-60))
show3Dpose(v0_3dp, ax3, data_type='h36m', radius=2, lcolor='black',angles=(20,-60))
show3Dpose(v1_3dp, ax3, data_type='h36m', radius=2, lcolor='blue',angles=(20,-60))
show3Dpose(v2_3dp, ax3, data_type='h36m', radius=2, lcolor='red',angles=(20,-60))
show3Dpose(v3_3dp, ax3, data_type='h36m', radius=2, lcolor='green',angles=(20,-60))
